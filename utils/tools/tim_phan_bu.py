...
SUB1_FILE = '/storage/submissions/sub20/submission_cam_16.txt'
SUB2_FILE = '/storage/submissions/sub25/submission_cam_16.txt'
...
for index, line1 in enumerate(lines1):
    print(index)
    for line2 in lines2:
        if line2[-1] != '-100000000' and line1[1:4] == line2[1:4]:
...
lines3 = [x[:4] for x in lines2 if x[-1] != '-100000000']
